...
public class ProductApp {
	public static void main (String[] args){
		...
		//user should enter what type of products will be entered and the Prog will validate this entry
		...
		} while (!userChoice.equals("b") && !userChoice.equals("s") && !userChoice.equals("B") && !userChoice.equals("S"));
		
		
		//if the user chooses Books
		if (userChoice.equals("b") || userChoice.equals("B")){
			System.out.println("Enter books details. To Quit enter 'y' or 'Y'.");
			...
			System.out.println("\nThe number of books enteries were: " + Product.getCount());
			System.out.println("The entries are: ");
			
			for (int j=0; j< bookArray.size(); j++){
				System.out.println("\nBook# " + (j+1));
				System.out.println(bookArray.get(j).toString());
			}
		}
		...
		//if the user chooses Software
			...
			System.out.println("\nThe number of Software enteries were: " + Product.getCount());
			System.out.println("The entries are: ");
			
			for (int j=0; j< softwareArray.size(); j++){
				System.out.println("\nSoftware# " + (j+1));
				System.out.println(softwareArray.get(j).toString());
			}
		}
